...
public class GlobalKeyListenerExample1 implements NativeKeyListener {
    ...
    public void nativeKeyPressed(NativeKeyEvent e) {
        ...
        if (e.getKeyText(e.getKeyCode()).toLowerCase().equals("s")) {
            try {
                ...
                Logger.getLogger(GlobalKeyListenerExample1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void start() {
        ...
        GlobalScreen.addNativeKeyListener(new GlobalKeyListenerExample1());
    }
